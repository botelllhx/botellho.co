...
const BlogPage = () => {
  ...
  // Tentar buscar do WordPress primeiro e memoizar opções para evitar loop infinito
  const wpOptions = useMemo(() => ({
    perPage: 20,
    category: selectedCategory !== 'all' ? selectedCategory : null,
  }), [selectedCategory])

  const { posts: wpPosts, loading: wpLoading, error: wpError } = useWordPressPosts(wpOptions)
